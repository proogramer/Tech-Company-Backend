    ...
    $.validator.setDefaults({
        submitHandler: function()
        {
            ...
            if(proceed)
            {
                ...
                g=f_data.append('userfile', $('input[type=file]')[0].files[0]);


                $.ajax
                ({
                    url: '<?php echo base_url()?>vendor/insert_vendor',
                    data:f_data,
                    processData: false,
                    contentType: false,
                    type: 'POST',
...
<div id="page-wrapper">
    <div class="container">
        <div class="messge_style_contact" id="myDiv_contact_add" style="color: green;font-size: 17px; margin: auto; text-align: center; display:none"> <font>Add Vendor Sucessfully </font> </div>

        <div id="page-inner">
    	    <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">Add Vendor</h1>
                </div>
            </div>
  		    <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel-body">
                         ...
                         ?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="permanent_address" id="permanent_address">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="pencard" id="pencard">
                            </div>
                            <div class="form-group">
                            ...
                            <input type="submit" class="btn btn-info" value="Add Vendor" name="submit">
                        </form>
                    </div>
                </div>
            </div>
