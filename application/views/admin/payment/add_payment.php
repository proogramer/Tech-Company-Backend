    ...
    $.validator.setDefaults({
        submitHandler: function()
        {
            ...
            if(proceed)
            {
                ...
                $.ajax
                ({
                    url: '<?php echo base_url(); ?>payment/add_payment_action',
                    data:f_data,
                    processData: false,
                    contentType: false,
                    type: 'POST',
...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="messge_style_contact" id="myDiv_contact_add" style="color: green;font-size: 17px; margin: auto; text-align: center; display:none"> <font>Add Payment Sucessfully </font> </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label>Payment</label>
                                    <input class="form-control" name="payment" id="payment" type="text">
                                </div>
